...
from rio_tiler.io import AsyncBaseReader, BaseReader, COGReader, MultiBaseReader
...
# ref: https://github.com/python/mypy/issues/5374
@dataclass  # type: ignore
class AsyncBaseFactory(metaclass=abc.ABCMeta):
    """BaseTiler Factory."""
...
@dataclass
class AsyncTilerFactory(AsyncBaseFactory):
    """Async Tiler Factory."""
    ...
    def bounds(self):
        ...
        async def bounds(src_path=Depends(self.path_dependency)):
            """Return the bounds of the COG."""
            async with self.reader(src_path.url, **self.reader_options) as src_dst:
                return {"bounds": src_dst.bounds}
