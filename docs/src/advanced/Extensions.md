...
- Goal: adds `/dataset/`, `/dataset/keys`, `/dataset/dict`, `/dataset/dimensions` and `/dataset/coordinates/{name}` endpoints which return metadata about a multidimensional Dataset (not a DataArray)
